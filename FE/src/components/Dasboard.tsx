...
const Dashboard = () => {
  ...
  return (
    <div className={`${!isCollapsed ? 'w-[1270px] ml-64' : 'w-[1350px] ml-24'} pt-20 flex justify-center gap-10 h-[auto]`}>
      <div className="shadow-md p-10 bg-gradient-to-r from-red-500 to-red-400 rounded-lg flex items-center gap-4 transition-transform transform hover:scale-105">
        <div className="text-white text-xl font-semibold">
          Tổng số sản phẩm: <span className="block text-2xl">{totalProducts}</span>
        </div>
      </div>

      <div className="shadow-md p-10 bg-gradient-to-r from-blue-500 to-blue-400 rounded-lg flex items-center gap-4 transition-transform transform hover:scale-105">
        <div className="text-white text-xl font-semibold">
