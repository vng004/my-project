...
const Navbar = () => {
  ...
  return (
    <div className='absolute '>
      {/* Top Bar */}
      <div
        className={`border-b-4 bg-gray-100  ${!isCollapsed ? 'ml-[280px] w-[1250px] ' : 'w-[1470px] ml-[65px]'
          }  h-[56px]  flex items-center justify-between fixed top-0 left-0 z-50`}
      >
        <div className=''></div>
        <div className='pr-16'>
      ...
      {/* Sidebar */}
      <div
        className={`rounded-3xl fixed inset-y-0  ${isCollapsed ? 'w-16 ' : 'w-[280px]'
          }   bg-white transition-width duration-300 shadow-2xl`}
      >
        <div className='relative z-10 '>
          ...
          <div
            className={`flex  ${isCollapsed
                ? 'w-16 rounded-none border-white flex justify-center hover:border-2 hover:rounded-md '
                : 'w-56 ml-7 mt-2'
            ...
            {!isCollapsed && (
              <div className='pl-3'>
                ...
                <Link
                  to='/login'
                  onClick={logout}
                  className='text-[13px] hover:text-red-500 flex items-center '
                >
          ...
          <div className='flex flex-col text-sm mt-5'>
            <Link
              ...
              className={`${isCollapsed
                  ...
                  : 'border-transparent pl-10 hover:rounded-r-full focus:rounded-r-full  hover:shadow-lg  focus:border-l-4 focus:border-l-blue-900 focus:shadow-xl focus:text-blue-400 hover:text-blue-400'
                } p-3`}
            >
            ...
            <Link
              ...
              className={`${isCollapsed
                  ? 'w-16 pl-5 hover:text-gray-400 focus:border-l-4 focus:border-l-blue-900'
                  : 'border-transparent pl-10 hover:rounded-r-full focus:rounded-r-full   hover:shadow-lg border-2 focus:border-l-4 focus:border-l-blue-900 focus:shadow-xl focus:text-blue-400 hover:text-blue-400'
                } p-3`}
