...
const Footer = () => {
  return (
    <div className="mt-24">
      <footer className="bg-black text-white w-full h-[450px] space-y-[140px] text-[16px]">
        <div className="">
          <div className="flex justify-center space-x-[600px] pt-12">
            <div className="flex space-x-[70px]">
              <div className="font-semibold text-[16px] space-y-10">
                <div>
              ...
              <div className="">
                ...
                <div className="text-[14px] text-[#858585] space-y-6 pt-6">
                  <div>
            ...
            <div className="flex text-black space-x-6 text-[17px]">
              <div className="bg-white h-[29px] w-[30px] rounded-full flex items-center justify-center">
        ...
        <div className="flex justify-center space-x-[500px] ">
          <div className="flex items-center space-x-2">
            ...
            <div  className="text-[18px] font-semibold">VietNam</div >
            <p className="text-[14px] text-[#858585] pl-5">© 2024 VNG, Inc. Mọi quyền được bảo lưu</p>
          </div>
          <div className=" flex text-[14px] text-[#858585] space-x-[50px] ">
            <div>
